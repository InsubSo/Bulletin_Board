    ...
    with st.sidebar:
        ...
        lpr_model_options = {
            "401 HVM": [
                ...
                "23FLEXHX", "23FLEXHX_PLUS","23FLEXHXE", "23FLEXHXE_CRYO", "23FLEXHXPL_CRYO",
                "23FLEXJXP"
            ],
            "416 UPL": [
                "FLEXGX/GXE-HXPL", "FLEXHXPL-HXPLC", "FLEXHXPLHXE_CM", "FLEXHX_PLUS-HXE", "FLEXHXE-HXEC", "FLEXGX-GXE-HX_U", "FLEXHX--HX_PLUS"
            ]
        }
        ...
        atac_model_options = {
            ...
            "PM": [
                "FlexFSeries", "FlexFLSeries",
                "FlexGLSeries", "FlexGBPM", "FlexGS",
                "FlexHXEPM", "FlexHSeries", "FlexHXPlus",
                "FlexJXP"
            ]
        }
        ...
        atac_spec_model_options = {
            ...
            "ExelanTopPlate": ["100A_Universal_Top_Plate", "FlexGL_Top_Plate", "Universal_Top_Plate_16CAM-HXPlus", "Universal_Top_Plate_HX_HX+_HXE-Razor", "Universal_Top_Plate_HX-HXPLUS", "FlexJXP_1.8.4-SP19-527", "Universal_Top_Plate_HX_HX+_HXE-Razor_NoTCU", "Universal_Top_Plate_HX-HXPLUS_NoTCU"],
            ...
            "FlexHXEBiasElectrode": ["CW184_SP17-510_FlexHXEBiasElectrode_NoCryo", "FlexHXEBiasElectrodeCRYO", "FlexHXEBiasElectrodeCRYO_DummyESC"],
            "FlexHSeriesBiasElectrode": ["FlexHSeriesBiasElectrode_Corvus"],
            "FlexJXPBiasElectrode": ["FLEX_JXP"],
            "FlexHXPlusBiasElectrode": ["FlexHXPlusBiasElectrode_Cryo", "FlexHXPlus - Blankoff", "FlexHXPlus", "FlexHXPlusBiasElectrodeTES20_40", "FlexHXPlusBiasElectrode_Cryo "],
            ...
            "FlexHXPlus": ["CW184_SP27-HF2_HXPlusCRYO_Razor_NoTCU"],
        ...
        aca_cfg_model_options = {
            "RF Cart": [
                ...
                'Flex HX+-RF',
                "Flex HXE CRYO-RF", "Flex HXPlus CRYO-RF", "Flex HXPlus_CRYO-RF",
                "Flex JXP-RF",
            ],
            "Top plate": [
            ...
            "Bias": [
                ...
                "Flex HX-PLUS-BE", "Flex HXPlus_CRYO-BE",
                "Flex JXP-BE",
            ],
            "PM": [
                ...
                "Flex HXE CRYO-PM", "Flex HXPlus_CRYO - PM",
                "Flex JXP-PM",
            ]
        }
...
def filter_lpr_model_name():
    ...
    filter_lpr_model_names = st.multiselect("Showing all the items listed. When you select them ,"
        ...
        "23FLEXHXE", "23FLEXHXE_CRYO", "23FLEXHXPL_CRYO", "23FLEXHX_PLUS", "23FLEXJXP",
        "FLEXGX/GXE-HXPL", "FLEXHXPL-HXPLC", "FLEXHXPLHXE_CM", "FLEXHX_PLUS-HXE", "FLEXHXE-HXEC", "FLEXGX-GXE-HX_U","FLEXHX--HX_PLUS"
